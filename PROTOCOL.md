...
`D` | Вказує чи треба для заряджання відкривати дверцята. Зазвичай це треба для універсального порту (B0), або для потру 110V (без параметра B).

Приклади повної команди:
```
connect:lDpl3b3d21Ma0vUBoMYdJuoOsVI3:B1:U54.6:P7:D
...
* token:токен - Встановити токен
* url:урл - Встановити URL
* admin:state:ready - Примусово встановити стан зарядної станції
* admin:state:busy
* admin:state:chagring
* admin:state:pause
...
* admin:fwupdate - Оновлення програмного забеспечення зарядної станції до останньої версії
* admin:fwupdate:версія - Оновлення програмного забеспечення зарядної станції до визначеної версії
* admin:solenoid:on - Подати живлення на соленоід дверцят
* admin:solenoid:off - Прибрати живлення з соленоіду дверцят
