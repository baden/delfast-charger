 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pe(n,e,t){return`firebase:${n}:${e}:${t}`}class he{constructor(e,t,i){this.persistence=e,this.auth=t,this.userKey=i;const{config:r,name:s}=this.auth;this.fullUserKey=Pe(this.userKey,r.apiKey,s),this.fullPersistenceKey=Pe("persistence",r.apiKey,s),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?se._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,i="authUser"){if(!t.length)return new he(H(Pt),e,i);const r=(await Promise.all(t.map(async I=>{if(await I._isAvailable())return I}))).filter(I=>I);let s=r[0]||H(Pt);const c=Pe(i,e.config.apiKey,e.name);let l=null;for(const I of t)try{const h=await I._get(c);if(h){const k=se._fromJSON(e,h);I!==s&&(l=k),s=I;break}}catch{}const g=r.filter(I=>I._shouldAllowMigration);return!s._shouldAllowMigration||!g.length?new he(s,e,i):(s=g[0],l&&await s._set(c,l.toJSON()),await Promise.all(t.map(async I=>{if(I!==s)try{await I._remove(c)}catch{}})),new he(s,e,i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,Ke=(n,e,t,i,r,s)=>{n.innerHTML=`
  ...
  `),n.querySelector("#start_charging").addEventListener("click",s)},Bo=(n,e,t,i,r,s)=>{const c=g=>{console.log("Stop charging"),r.publish(`charger/${e}/commands`,`stop:${t.uid}`)};Un(n,e,t,i,r,`
    <div class="compact_measures">${(g=>`
      <span>U:${(g.voltage||0).toFixed(0)}V</span>
      <span>I:${((g.current||0)/1e3).toFixed(3)}A</span>
      <span>P:${(g.power||0).toFixed(0)}W</span>
      <span>E:${(g.energy||0).toFixed(0)}Wh</span>
    `)(s)}</div>
  ...
  `),n.querySelector("#stop_charging").addEventListener("click",c)},Fo=(n,e,t,i,r,s)=>{var l,g,I,h;const c=k=>{console.log("User connected to charger"),r.publish(`charger/${e}/commands`,`stop:${t.uid}`)};Un(n,e,t,i,r,`
    <div>
  ...
  `},$o=(n,e,t,i,r)=>{const s=t.uid;console.log("---- uid=",s),console.log("charger=",Co);let c=setTimeout(()=>{Lo(n,e,t,i,r)},15e3);r.onMessageArrived=l=>{switch(console.log("onMessageArrived",l),clearTimeout(c),l.status){case"init":Uo(n,e,t,i,r);break;case"ready":xo(n,e,t,i,r);break;case"busy":Bo(n,e,t,i,r,l);break;case"charging":Fo(n,e,t,i,r,l);break;default:Vo(n)}},Oo(n,e,t,i,r)},qo=document.getElementById("app"),Ho=n=>{if(console.log("App:element",n),!ue)return To(n);const e=new yo,t=new wo("charger_"+ue);t.onMQTTConnect=()=>{console.log("onMQTTConnect"),t.subscribe("charger/"+ue+"/status"),t.subscribe("charger/"+ue+"/data");const i=e.getCurrentUser();i&&t.publish("charger/"+ue+"/commands",`hello:${i.uid}`)},t.onMQTTLost=()=>{console.log("onMQTTLost. TODO: reconnect")},e.onAuthStateChanged(i=>(console.log("user=",i),i?(t.connect(),$o(n,ue,i,e,t)):(t.disconnect(),So(n,e))))};Ho(qo);
