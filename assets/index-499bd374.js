 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gt=function(n){const e=[];let t=0;for(let i=0;i<n.length;i++){let r=n.charCodeAt(i);r<128?e[t++]=r:r<2048?(e[t++]=r>>6|192,e[t++]=r&63|128):(r&64512)===55296&&i+1<n.length&&(n.charCodeAt(i+1)&64512)===56320?(r=65536+((r&1023)<<10)+(n.charCodeAt(++i)&1023),e[t++]=r>>18|240,e[t++]=r>>12&63|128,e[t++]=r>>6&63|128,e[t++]=r&63|128):(e[t++]=r>>12|224,e[t++]=r>>6&63|128,e[t++]=r&63|128)}return e},$n=function(n){const e=[];let t=0,i=0;for(;t<n.length;){const r=n[t++];if(r<128)e[i++]=String.fromCharCode(r);else if(r>191&&r<224){const s=n[t++];e[i++]=String.fromCharCode((r&31)<<6|s&63)}else if(r>239&&r<365){const s=n[t++],c=n[t++],l=n[t++],g=((r&7)<<18|(s&63)<<12|(c&63)<<6|l&63)-65536;e[i++]=String.fromCharCode(55296+(g>>10)),e[i++]=String.fromCharCode(56320+(g&1023))}else{const s=n[t++],c=n[t++];e[i++]=String.fromCharCode((r&15)<<12|(s&63)<<6|c&63)}}return e.join("")},Kt={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(n,e){if(!Array.isArray(n))throw Error("encodeByteArray takes an array as a parameter");this.init_();const t=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,i=[];for(let r=0;r<n.length;r+=3){const s=n[r],c=r+1<n.length,l=c?n[r+1]:0,g=r+2<n.length,I=g?n[r+2]:0,h=s>>2,N=(s&3)<<4|l>>4;let m=(l&15)<<2|I>>6,O=I&63;g||(O=64,c||(m=64)),i.push(t[h],t[N],t[m],t[O])}return i.join("")},encodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(n):this.encodeByteArray(Gt(n),e)},decodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(n):$n(this.decodeStringToByteArray(n,e))},decodeStringToByteArray(n,e){this.init_();const t=e?this.charToByteMapWebSafe_:this.charToByteMap_,i=[];for(let r=0;r<n.length;){const s=t[n.charAt(r++)],l=r<n.length?t[n.charAt(r)]:0;++r;const I=r<n.length?t[n.charAt(r)]:64;++r;const N=r<n.length?t[n.charAt(r)]:64;if(++r,s==null||l==null||I==null||N==null)throw new Hn;const m=s<<2|l>>4;if(i.push(m),I!==64){const O=l<<4&240|I>>2;if(i.push(O),N!==64){const U=I<<6&192|N;i.push(U)}}}return i},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let n=0;n<this.ENCODED_VALS.length;n++)this.byteToCharMap_[n]=this.ENCODED_VALS.charAt(n),this.charToByteMap_[this.byteToCharMap_[n]]=n,this.byteToCharMapWebSafe_[n]=this.ENCODED_VALS_WEBSAFE.charAt(n),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[n]]=n,n>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(n)]=n,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(n)]=n)}}};class Hn extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const qn=function(n){const e=Gt(n);return Kt.encodeByteArray(e,!0)},Jt=function(n){return qn(n).replace(/\./g,"")},Qt=function(n){try{return Kt.decodeString(n,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var k;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(k||(k={}));const gi={debug:k.DEBUG,verbose:k.VERBOSE,info:k.INFO,warn:k.WARN,error:k.ERROR,silent:k.SILENT},pi=k.INFO,_i={[k.DEBUG]:"log",[k.VERBOSE]:"log",[k.INFO]:"info",[k.WARN]:"warn",[k.ERROR]:"error"},mi=(n,e,...t)=>{if(e<n.logLevel)return;const i=new Date().toISOString(),r=_i[e];if(r)console[r](`[${i}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Xt{constructor(e){this.name=e,this._logLevel=pi,this._logHandler=mi,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in k))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?gi[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,k.DEBUG,...e),this._logHandler(this,k.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,k.VERBOSE,...e),this._logHandler(this,k.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,k.INFO,...e),this._logHandler(this,k.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,k.WARN,...e),this._logHandler(this,k.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,k.ERROR,...e),this._logHandler(this,k.ERROR,...e)}}const vi=(n,e)=>e.some(t=>n instanceof t);let Tt,bt;function Ii(){return Tt||(Tt=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function yi(){return bt||(bt=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Zt=new WeakMap,rt=new WeakMap,en=new WeakMap,Ye=new WeakMap,ht=new WeakMap;function Ei(n){const e=new Promise((t,i)=>{const r=()=>{n.removeEventListener("success",s),n.removeEventListener("error",c)},s=()=>{t(X(n.result)),r()},c=()=>{i(n.error),r()};n.addEventListener("success",s),n.addEventListener("error",c)});return e.then(t=>{t instanceof IDBCursor&&Zt.set(t,n)}).catch(()=>{}),ht.set(e,n),e}function wi(n){if(rt.has(n))return;const e=new Promise((t,i)=>{const r=()=>{n.removeEventListener("complete",s),n.removeEventListener("error",c),n.removeEventListener("abort",c)},s=()=>{t(),r()},c=()=>{i(n.error||new DOMException("AbortError","AbortError")),r()};n.addEventListener("complete",s),n.addEventListener("error",c),n.addEventListener("abort",c)});rt.set(n,e)}let st={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return rt.get(n);if(e==="objectStoreNames")return n.objectStoreNames||en.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return X(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function Ti(n){st=n(st)}function bi(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const i=n.call(Xe(this),e,...t);return en.set(i,e.sort?e.sort():[e]),X(i)}:yi().includes(n)?function(...e){return n.apply(Xe(this),e),X(Zt.get(this))}:function(...e){return X(n.apply(Xe(this),e))}}function Si(n){return typeof n=="function"?bi(n):(n instanceof IDBTransaction&&wi(n),vi(n,Ii())?new Proxy(n,st):n)}function X(n){if(n instanceof IDBRequest)return Ei(n);if(Ye.has(n))return Ye.get(n);const e=Si(n);return e!==n&&(Ye.set(n,e),ht.set(e,n)),e}const Xe=n=>ht.get(n);function Ai(n,e,{blocked:t,upgrade:i,blocking:r,terminated:s}={}){const c=indexedDB.open(n,e),l=X(c);return i&&c.addEventListener("upgradeneeded",g=>{i(X(c.result),g.oldVersion,g.newVersion,X(c.transaction))}),t&&c.addEventListener("blocked",()=>t()),l.then(g=>{s&&g.addEventListener("close",()=>s()),r&&g.addEventListener("versionchange",()=>r())}).catch(()=>{}),l}const Ci=["get","getKey","getAll","getAllKeys","count"],Ri=["put","add","delete","clear"],Ze=new Map;function St(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Ze.get(e))return Ze.get(e);const t=e.replace(/FromIndex$/,""),i=e!==t,r=Ri.includes(t);if(!(t in(i?IDBIndex:IDBObjectStore).prototype)||!(r||Ci.includes(t)))return;const s=async function(c,...l){const g=this.transaction(c,r?"readwrite":"readonly");let I=g.store;return i&&(I=I.index(l.shift())),(await Promise.all([I[t](...l),r&&g.done]))[0]};return Ze.set(e,s),s}Ti(n=>({...n,get:(e,t,i)=>St(e,t)||n.get(e,t,i),has:(e,t)=>!!St(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ki{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Ni(t)){const i=t.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(t=>t).join(" ")}}function Ni(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ot="@firebase/app",At="0.9.7";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ar="firebase-heartbeat-database",cr=1,Ee="firebase-heartbeat-store";let et=null;function rn(){return et||(et=Ai(ar,cr,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(Ee)}}}).catch(n=>{throw Z.create("idb-open",{originalErrorMessage:n.message})})),et}async function lr(n){try{return(await rn()).transaction(Ee).objectStore(Ee).get(sn(n))}catch(e){if(e instanceof ee)ce.warn(e.message);else{const t=Z.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});ce.warn(t.message)}}}async function Ct(n,e){try{const i=(await rn()).transaction(Ee,"readwrite");return await i.objectStore(Ee).put(e,sn(n)),i.done}catch(t){if(t instanceof ee)ce.warn(t.message);else{const i=Z.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});ce.warn(i.message)}}}function sn(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dr=1024,ur=30*24*60*60*1e3;class hr{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new gr(t),this._heartbeatsCachePromise=this._storage.read().then(i=>(this._heartbeatsCache=i,i))}async triggerHeartbeat(){const t=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=Rt();if(this._heartbeatsCache===null&&(this._heartbeatsCache=await this._heartbeatsCachePromise),!(this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(r=>r.date===i)))return this._heartbeatsCache.heartbeats.push({date:i,agent:t}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(r=>{const s=new Date(r.date).valueOf();return Date.now()-s<=ur}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache===null||this._heartbeatsCache.heartbeats.length===0)return"";const e=Rt(),{heartbeatsToSend:t,unsentEntries:i}=fr(this._heartbeatsCache.heartbeats),r=Jt(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}}function Rt(){return new Date().toISOString().substring(0,10)}function fr(n,e=dr){const t=[];let i=n.slice();for(const r of n){const s=t.find(c=>c.agent===r.agent);if(s){if(s.dates.push(r.date),kt(t)>e){s.dates.pop();break}}else if(t.push({agent:r.agent,dates:[r.date]}),kt(t)>e){t.pop();break}i=i.slice(1)}return{heartbeatsToSend:t,unsentEntries:i}}class gr{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return ti()?ni().then(()=>!0).catch(()=>!1):!1}async read(){return await this._canUseIndexedDBPromise?await lr(this.app)||{heartbeats:[]}:{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const r=await this.read();return Ct(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var t;if(await this._canUseIndexedDBPromise){const r=await this.read();return Ct(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function kt(n){return Jt(JSON.stringify({version:2,heartbeats:n})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pr(n){ye(new pe("platform-logger",e=>new ki(e),"PRIVATE")),ye(new pe("heartbeat",e=>new hr(e),"PRIVATE")),he(ot,At,n),he(ot,At,"esm2017"),he("fire-js","")}pr("");var _r="firebase",mr="9.19.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */he(_r,mr,"app");function ft(n,e){var t={};for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&e.indexOf(i)<0&&(t[i]=n[i]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var r=0,i=Object.getOwnPropertySymbols(n);r<i.length;r++)e.indexOf(i[r])<0&&Object.prototype.propertyIsEnumerable.call(n,i[r])&&(t[i[r]]=n[i[r]]);return t}function on(){return{["dependent-sdk-initialized-before-auth"]:"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const vr=on,an=new be("auth","Firebase",on());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nt=new Xt("@firebase/auth");function Pe(n,...e){Nt.logLevel<=k.ERROR&&Nt.error(`Auth (${qe}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function V(n,...e){throw gt(n,...e)}function B(n,...e){return gt(n,...e)}function cn(n,e,t){const i=Object.assign(Object.assign({},vr()),{[e]:t});return new be("auth","Firebase",i).create(e,{appName:n.name})}function Ir(n,e,t){const i=t;if(!(e instanceof i))throw i.name!==e.constructor.name&&V(n,"argument-error"),cn(n,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function gt(n,...e){if(typeof n!="string"){const t=e[0],i=[...e.slice(1)];return i[0]&&(i[0].appName=n.name),n._errorFactory.create(t,...i)}return an.create(n,...e)}function T(n,e,...t){if(!n)throw gt(e,...t)}function H(n){const e="INTERNAL ASSERTION FAILED: "+n;throw Pe(e),new Error(e)}function W(n,e){n||H(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mt=new Map;function q(n){W(n instanceof Function,"Expected a class definition");let e=Mt.get(n);return e?(W(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,Mt.set(n,e),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lt(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.href)||""}function wr(){return Pt()==="http:"||Pt()==="https:"}function Pt(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Fr(n,e){const t=await dn(n,{},async()=>{const i=Se({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:r,apiKey:s}=n.config,c=un(n,r,"/v1/token",`key=${s}`),l=await n._getAdditionalHeaders();return l["Content-Type"]="application/x-www-form-urlencoded",ln.fetch()(c,{method:"POST",headers:l,body:i})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fn{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}fn.type="NONE";const Dt=fn;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function De(n,e,t){return`firebase:${n}:${e}:${t}`}class fe{constructor(e,t,i){this.persistence=e,this.auth=t,this.userKey=i;const{config:r,name:s}=this.auth;this.fullUserKey=De(this.userKey,r.apiKey,s),this.fullPersistenceKey=De("persistence",r.apiKey,s),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?ae._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,i="authUser"){if(!t.length)return new fe(q(Dt),e,i);const r=(await Promise.all(t.map(async I=>{if(await I._isAvailable())return I}))).filter(I=>I);let s=r[0]||q(Dt);const c=De(i,e.config.apiKey,e.name);let l=null;for(const I of t)try{const h=await I._get(c);if(h){const N=ae._fromJSON(e,h);I!==s&&(l=N),s=I;break}}catch{}const g=r.filter(I=>I._shouldAllowMigration);return!s._shouldAllowMigration||!g.length?new fe(s,e,i):(s=g[0],l&&await s._set(c,l.toJSON()),await Promise.all(t.map(async I=>{if(I!==s)try{await I._remove(c)}catch{}})),new fe(s,e,i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ot(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(_n(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(gn(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(vn(e))return"Blackberry";if(In(e))return"Webos";if(mt(e))return"Safari";if((e.includes("chrome/")||pn(e))&&!e.includes("edge/"))return"Chrome";if(mn(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=n.match(t);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function gn(n=P()){return/firefox\//i.test(n)}function mt(n=P()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function pn(n=P()){return/crios\//i.test(n)}function _n(n=P()){return/iemobile/i.test(n)}function mn(n=P()){return/android/i.test(n)}function vn(n=P()){return/blackberry/i.test(n)}function In(n=P()){return/webos/i.test(n)}function je(n=P()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Vr(n=P()){var e;return je(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function $r(){return ei()&&document.documentMode===10}function yn(n=P()){return je(n)||mn(n)||In(n)||vn(n)||/windows phone/i.test(n)||_n(n)}function Hr(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function En(n,e=[]){let t;switch(n){case"Browser":t=Ot(P());break;case"Worker":t=`${Ot(P())}-${n}`;break;default:t=n}const i=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${qe}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tn{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return H("not implemented")}_getIdTokenResponse(e){return H("not implemented")}_linkToIdToken(e,t){return H("not implemented")}_getReauthenticationResolver(e){return H("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _e{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,t,i,r=!1){const s=await ae._fromIdTokenResponse(e,i,r),c=xt(i);return new _e({user:s,providerId:c,_tokenResponse:i,operationType:t})}static async _forOperation(e,t,i){await e._updateTokensIfNecessary(i,!0);const r=xt(i);return new _e({user:e,providerId:r,_tokenResponse:i,operationType:t})}}function xt(n){return n.providerId?n.providerId:"phoneNumber"in n?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Yr(n,e,t=!1){const i="signIn",r=await bn(n,i,e),s=await _e._fromIdTokenResponse(n,i,r);return t||await n._updateCurrentUser(s.user),s}function Xr(n,e,t,i){return de(n).onIdTokenChanged(e,t,i)}function Zr(n,e,t){return de(n).beforeAuthStateChanged(e,t)}function es(n,e,t,i){return de(n).onAuthStateChanged(e,t,i)}const Ve="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sn{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(Ve,"1"),this.storage.removeItem(Ve),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kn(){return typeof F().WorkerGlobalScope<"u"&&typeof F().importScripts=="function"}async function cs(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function ls(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function ds(){return kn()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dn(n,e){return e?q(e):(T(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class On{constructor(e,t,i,r,s=!1){this.auth=e,this.resolver=i,this.user=r,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:i,postBody:r,tenantId:s,error:c,type:l}=e;if(c){this.reject(c);return}const g={auth:this.auth,requestUri:t,sessionId:i,tenantId:s||void 0,postBody:r||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(g))}catch(I){this.reject(I)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return ys;case"linkViaPopup":case"linkViaRedirect":return ws;case"reauthViaPopup":case"reauthViaRedirect":return Es;default:V(this.auth,"internal-error")}}resolve(e){W(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){W(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ss="pendingRedirect",Oe=new Map;class As extends On{constructor(e,t,i=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,i),this.eventId=null}async execute(){let e=Oe.get(this.auth._key());if(!e){try{const i=await Cs(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(i)}catch(t){e=()=>Promise.reject(t)}Oe.set(this.auth._key(),e)}return this.bypassAuthState||Oe.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Cs(n,e){const t=Ns(e),i=ks(n);if(!await i._isAvailable())return!1;const r=await i._get(t)==="true";return await i._remove(t),r}function Rs(n,e){Oe.set(n._key(),e)}function ks(n){return q(n._redirectPersistence)}function Ns(n){return De(Ss,n.config.apiKey,n.name)}async function Ms(n,e,t=!1){const i=ze(n),r=Dn(i,e),c=await new As(i,r,t).execute();return c&&!t&&(delete c.user._redirectEventId,await i._persistUserIfCurrent(c.user),await i._setRedirectUser(null,e)),c}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ps=10*60*1e3;class Ds{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach(i=>{this.isEventForConsumer(e,i)&&(t=!0,this.sendToConsumer(e,i),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!Os(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){var i;if(e.error&&!Ln(e)){const r=((i=e.error.code)===null||i===void 0?void 0:i.split("auth/")[1])||"internal-error";t.onError(B(this.auth,r))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const i=t.eventId===null||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&i}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=Ps&&this.cachedEventUids.clear(),this.cachedEventUids.has(Vt(e))}saveEventToCache(e){this.cachedEventUids.add(Vt(e)),this.lastProcessedEventTime=Date.now()}}function Vt(n){return[n.type,n.eventId,n.sessionId,n.tenantId].filter(e=>e).join("-")}function Ln({type:n,error:e}){return n==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function Os(n){switch(n.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return Ln(n);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vs=new Ae(3e4,6e4);function $t(){const n=F().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function $s(n){return new Promise((e,t)=>{var i,r,s;function c(){$t(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{$t(),t(B(n,"network-request-failed"))},timeout:Vs.get()})}if(!((r=(i=F().gapi)===null||i===void 0?void 0:i.iframes)===null||r===void 0)&&r.Iframe)e(gapi.iframes.getContext());else if(!((s=F().gapi)===null||s===void 0)&&s.load)c();else{const l=Is("iframefcb");return F()[l]=()=>{gapi.load?c():t(B(n,"network-request-failed"))},vs(`https://apis.google.com/js/api.js?onload=${l}`).catch(g=>t(g))}}).catch(e=>{throw Le=null,e})}let Le=null;function Hs(n){return Le=Le||$s(n),Le}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qs={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Ys=500,Xs=600,Zs="_blank",eo="http://localhost";class Ht{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function to(n,e,t,i=Ys,r=Xs){const s=Math.max((window.screen.availHeight-r)/2,0).toString(),c=Math.max((window.screen.availWidth-i)/2,0).toString();let l="";const g=Object.assign(Object.assign({},Qs),{width:i.toString(),height:r.toString(),top:s,left:c}),I=P().toLowerCase();t&&(l=pn(I)?Zs:t),gn(I)&&(e=e||eo,g.scrollbars="yes");const h=Object.entries(g).reduce((m,[O,U])=>`${m}${O}=${U},`,"");if(Vr(I)&&l!=="_self")return no(e||"",l),new Ht(null);const N=window.open(e||"",l,h);T(N,n,"popup-blocked");try{N.focus()}catch{}return new Ht(N)}function no(n,e){const t=document.createElement("a");t.href=n,t.target=e;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ho=5*60,fo=Yt("authIdTokenMaxAge")||ho;let zt=null;const go=n=>async e=>{const t=e&&await e.getIdTokenResult(),i=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(i&&i>fo)return;const r=t==null?void 0:t.token;zt!==r&&(zt=r,await fetch(n,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function po(n=or()){const e=tn(n,"auth");if(e.isInitialized())return e.getImmediate();const t=yr(n,{popupRedirectResolver:ao,persistence:[_s,rs,Rn]}),i=Yt("authTokenSyncURL");if(i){const s=go(i);Zr(t,s,()=>s(t.currentUser)),Xr(t,c=>s(c))}const r=Kn("auth");return r&&jr(t,`http://${r}`),t}uo("Browser");const _o={apiKey:"AIzaSyC0UMDhVLTX_lhPBdqU3BnHSg6z126F-_o",authDomain:"delfast-chargger-auth.firebaseapp.com",projectId:"delfast-chargger-auth",storageBucket:"delfast-chargger-auth.appspot.com",messagingSenderId:"146029576932",appId:"1:146029576932:web:ed75929b80ef941c11e2f1"},mo=nn(_o),vo=po(mo),Io=new $;class yo{constructor(){this.auth=vo,this.googleProvider=Io}signInWithGoogle(){return bs(this.auth,this.googleProvider)}signOut(){return this.auth.signOut()}onAuthStateChanged(e){return es(this.auth,e)}isInitialized(){return new Promise(e=>{this.auth.onAuthStateChanged(e)})}getCurrentUser(){return this.auth.currentUser}}var it=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},He={},Eo={get exports(){return He},set exports(n){He=n}};(function(n,e){(function(i,r){n.exports=r()})(it,function(){var i=function(r){var s="@VERSION@-@BUILDLEVEL@",c=r.localStorage||function(){var o={};return{setItem:function(a,u){o[a]=u},getItem:function(a){return o[a]},removeItem:function(a){delete o[a]}}}(),l={CONNECT:1,CONNACK:2,PUBLISH:3,PUBACK:4,PUBREC:5,PUBREL:6,PUBCOMP:7,SUBSCRIBE:8,SUBACK:9,UNSUBSCRIBE:10,UNSUBACK:11,PINGREQ:12,PINGRESP:13,DISCONNECT:14},g=function(o,a){for(var u in o)if(o.hasOwnProperty(u))if(a.hasOwnProperty(u)){if(typeof o[u]!==a[u])throw new Error(m(h.INVALID_TYPE,[typeof o[u],u]))}else{var f="Unknown property, "+u+". Valid properties are:";for(var _ in a)a.hasOwnProperty(_)&&(f=f+" "+_);throw new Error(f)}},I=function(o,a){return function(){return o.apply(a,arguments)}},h={OK:{code:0,text:"AMQJSC0000I OK."},CONNECT_TIMEOUT:{code:1,text:"AMQJSC0001E Connect timed out."},SUBSCRIBE_TIMEOUT:{code:2,text:"AMQJS0002E Subscribe timed out."},UNSUBSCRIBE_TIMEOUT:{code:3,text:"AMQJS0003E Unsubscribe timed out."},PING_TIMEOUT:{code:4,text:"AMQJS0004E Ping timed out."},INTERNAL_ERROR:{code:5,text:"AMQJS0005E Internal error. Error Message: {0}, Stack trace: {1}"},CONNACK_RETURNCODE:{code:6,text:"AMQJS0006E Bad Connack return code:{0} {1}."},SOCKET_ERROR:{code:7,text:"AMQJS0007E Socket error:{0}."},SOCKET_CLOSE:{code:8,text:"AMQJS0008I Socket closed."},MALFORMED_UTF:{code:9,text:"AMQJS0009E Malformed UTF data:{0} {1} {2}."},UNSUPPORTED:{code:10,text:"AMQJS0010E {0} is not supported by this browser."},INVALID_STATE:{code:11,text:"AMQJS0011E Invalid state {0}."},INVALID_TYPE:{code:12,text:"AMQJS0012E Invalid type {0} for {1}."},INVALID_ARGUMENT:{code:13,text:"AMQJS0013E Invalid argument {0} for {1}."},UNSUPPORTED_OPERATION:{code:14,text:"AMQJS0014E Unsupported operation."},INVALID_STORED_DATA:{code:15,text:"AMQJS0015E Invalid data in local storage key={0} value={1}."},INVALID_MQTT_MESSAGE_TYPE:{code:16,text:"AMQJS0016E Invalid MQTT message type {0}."},MALFORMED_UNICODE:{code:17,text:"AMQJS0017E Malformed Unicode string:{0} {1}."},BUFFER_FULL:{code:18,text:"AMQJS0018E Message buffer is full, maximum buffer size: {0}."}},N={0:"Connection Accepted",1:"Connection Refused: unacceptable protocol version",2:"Connection Refused: identifier rejected",3:"Connection Refused: server unavailable",4:"Connection Refused: bad user name or password",5:"Connection Refused: not authorized"},m=function(o,a){var u=o.text;if(a){for(var f,_,p=0;p<a.length;p++)if(f="{"+p+"}",_=u.indexOf(f),_>0){var v=u.substring(0,_),S=u.substring(_+f.length);u=v+a[p]+S}}return u},O=[0,6,77,81,73,115,100,112,3],U=[0,4,77,81,84,84,4],M=function(o,a){this.type=o;for(var u in a)a.hasOwnProperty(u)&&(this[u]=a[u])};M.prototype.encode=function(){var o=(this.type&15)<<4,a=0,u=[],f=0,_;switch(this.messageIdentifier!==void 0&&(a+=2),this.type){case l.CONNECT:switch(this.mqttVersion){case 3:a+=O.length+3;break;case 4:a+=U.length+3;break}a+=D(this.clientId)+2,this.willMessage!==void 0&&(a+=D(this.willMessage.destinationName)+2,_=this.willMessage.payloadBytes,_ instanceof Uint8Array||(_=new Uint8Array(v)),a+=_.byteLength+2),this.userName!==void 0&&(a+=D(this.userName)+2),this.password!==void 0&&(a+=D(this.password)+2);break;case l.SUBSCRIBE:o|=2;for(var p=0;p<this.topics.length;p++)u[p]=D(this.topics[p]),a+=u[p]+2;a+=this.requestedQos.length;break;case l.UNSUBSCRIBE:o|=2;for(var p=0;p<this.topics.length;p++)u[p]=D(this.topics[p]),a+=u[p]+2;break;case l.PUBREL:o|=2;break;case l.PUBLISH:this.payloadMessage.duplicate&&(o|=8),o=o|=this.payloadMessage.qos<<1,this.payloadMessage.retained&&(o|=1),f=D(this.payloadMessage.destinationName),a+=f+2;var v=this.payloadMessage.payloadBytes;a+=v.byteLength,v instanceof ArrayBuffer?v=new Uint8Array(v):v instanceof Uint8Array||(v=new Uint8Array(v.buffer));break}var S=ke(a),w=S.length+1,R=new ArrayBuffer(a+w),E=new Uint8Array(R);if(E[0]=o,E.set(S,1),this.type==l.PUBLISH)w=x(this.payloadMessage.destinationName,f,E,w);else if(this.type==l.CONNECT){switch(this.mqttVersion){case 3:E.set(O,w),w+=O.length;break;case 4:E.set(U,w),w+=U.length;break}var d=0;this.cleanSession&&(d=2),this.willMessage!==void 0&&(d|=4,d|=this.willMessage.qos<<3,this.willMessage.retained&&(d|=32)),this.userName!==void 0&&(d|=128),this.password!==void 0&&(d|=64),E[w++]=d,w=ne(this.keepAliveInterval,E,w)}switch(this.messageIdentifier!==void 0&&(w=ne(this.messageIdentifier,E,w)),this.type){case l.CONNECT:w=x(this.clientId,D(this.clientId),E,w),this.willMessage!==void 0&&(w=x(this.willMessage.destinationName,D(this.willMessage.destinationName),E,w),w=ne(_.byteLength,E,w),E.set(_,w),w+=_.byteLength),this.userName!==void 0&&(w=x(this.userName,D(this.userName),E,w)),this.password!==void 0&&(w=x(this.password,D(this.password),E,w));break;case l.PUBLISH:E.set(v,w);break;case l.SUBSCRIBE:for(var p=0;p<this.topics.length;p++)w=x(this.topics[p],u[p],E,w),E[w++]=this.requestedQos[p];break;case l.UNSUBSCRIBE:for(var p=0;p<this.topics.length;p++)w=x(this.topics[p],u[p],E,w);break}return R};function me(o,a){var u=a,f=o[a],_=f>>4,p=f&=15;a+=1;var v,S=0,w=1;do{if(a==o.length)return[null,u];v=o[a++],S+=(v&127)*w,w*=128}while(v&128);var R=a+S;if(R>o.length)return[null,u];var E=new M(_);switch(_){case l.CONNACK:var d=o[a++];d&1&&(E.sessionPresent=!0),E.returnCode=o[a++];break;case l.PUBLISH:var A=p>>1&3,b=j(o,a);a+=2;var L=ve(o,a,b);a+=b,A>0&&(E.messageIdentifier=j(o,a),a+=2);var C=new G(o.subarray(a,R));(p&1)==1&&(C.retained=!0),(p&8)==8&&(C.duplicate=!0),C.qos=A,C.destinationName=L,E.payloadMessage=C;break;case l.PUBACK:case l.PUBREC:case l.PUBREL:case l.PUBCOMP:case l.UNSUBACK:E.messageIdentifier=j(o,a);break;case l.SUBACK:E.messageIdentifier=j(o,a),a+=2,E.returnCode=o.subarray(a,R);break}return[E,R]}function ne(o,a,u){return a[u++]=o>>8,a[u++]=o%256,u}function x(o,a,u,f){return f=ne(a,u,f),ue(o,u,f),f+a}function j(o,a){return 256*o[a]+o[a+1]}function ke(o){var a=new Array(1),u=0;do{var f=o%128;o=o>>7,o>0&&(f|=128),a[u++]=f}while(o>0&&u<4);return a}function D(o){for(var a=0,u=0;u<o.length;u++){var f=o.charCodeAt(u);f>2047?(55296<=f&&f<=56319&&(u++,a++),a+=3):f>127?a+=2:a++}return a}function ue(o,a,u){for(var f=u,_=0;_<o.length;_++){var p=o.charCodeAt(_);if(55296<=p&&p<=56319){var v=o.charCodeAt(++_);if(isNaN(v))throw new Error(m(h.MALFORMED_UNICODE,[p,v]));p=(p-55296<<10)+(v-56320)+65536}p<=127?a[f++]=p:p<=2047?(a[f++]=p>>6&31|192,a[f++]=p&63|128):p<=65535?(a[f++]=p>>12&15|224,a[f++]=p>>6&63|128,a[f++]=p&63|128):(a[f++]=p>>18&7|240,a[f++]=p>>12&63|128,a[f++]=p>>6&63|128,a[f++]=p&63|128)}return a}function ve(o,a,u){for(var f="",_,p=a;p<a+u;){var v=o[p++];if(v<128)_=v;else{var S=o[p++]-128;if(S<0)throw new Error(m(h.MALFORMED_UTF,[v.toString(16),S.toString(16),""]));if(v<224)_=64*(v-192)+S;else{var w=o[p++]-128;if(w<0)throw new Error(m(h.MALFORMED_UTF,[v.toString(16),S.toString(16),w.toString(16)]));if(v<240)_=4096*(v-224)+64*S+w;else{var R=o[p++]-128;if(R<0)throw new Error(m(h.MALFORMED_UTF,[v.toString(16),S.toString(16),w.toString(16),R.toString(16)]));if(v<248)_=262144*(v-240)+4096*S+64*w+R;else throw new Error(m(h.MALFORMED_UTF,[v.toString(16),S.toString(16),w.toString(16),R.toString(16)]))}}}_>65535&&(_-=65536,f+=String.fromCharCode(55296+(_>>10)),_=56320+(_&1023)),f+=String.fromCharCode(_)}return f}var Ne=function(o,a){this._client=o,this._keepAliveInterval=a*1e3,this.isReset=!1;var u=new M(l.PINGREQ).encode(),f=function(p){return function(){return _.apply(p)}},_=function(){this.isReset?(this.isReset=!1,this._client._trace("Pinger.doPing","send PINGREQ"),this._client.socket.send(u),this.timeout=setTimeout(f(this),this._keepAliveInterval)):(this._client._trace("Pinger.doPing","Timed out"),this._client._disconnected(h.PING_TIMEOUT.code,m(h.PING_TIMEOUT)))};this.reset=function(){this.isReset=!0,clearTimeout(this.timeout),this._keepAliveInterval>0&&(this.timeout=setTimeout(f(this),this._keepAliveInterval))},this.cancel=function(){clearTimeout(this.timeout)}},z=function(o,a,u,f){a||(a=30);var _=function(p,v,S){return function(){return p.apply(v,S)}};this.timeout=setTimeout(_(u,o,f),a*1e3),this.cancel=function(){clearTimeout(this.timeout)}},y=function(o,a,u,f,_){if(!("WebSocket"in r&&r.WebSocket!==null))throw new Error(m(h.UNSUPPORTED,["WebSocket"]));if(!("ArrayBuffer"in r&&r.ArrayBuffer!==null))throw new Error(m(h.UNSUPPORTED,["ArrayBuffer"]));this._trace("Paho.Client",o,a,u,f,_),this.host=a,this.port=u,this.path=f,this.uri=o,this.clientId=_,this._wsuri=null,this._localKey=a+":"+u+(f!="/mqtt"?":"+f:"")+":"+_+":",this._msg_queue=[],this._buffered_msg_queue=[],this._sentMessages={},this._receivedMessages={},this._notify_msg_sent={},this._message_identifier=1,this._sequence=0;for(var p in c)(p.indexOf("Sent:"+this._localKey)===0||p.indexOf("Received:"+this._localKey)===0)&&this.restore(p)};y.prototype.host=null,y.prototype.port=null,y.prototype.path=null,y.prototype.uri=null,y.prototype.clientId=null,y.prototype.socket=null,y.prototype.connected=!1,y.prototype.maxMessageIdentifier=65536,y.prototype.connectOptions=null,y.prototype.hostIndex=null,y.prototype.onConnected=null,y.prototype.onConnectionLost=null,y.prototype.onMessageDelivered=null,y.prototype.onMessageArrived=null,y.prototype.traceFunction=null,y.prototype._msg_queue=null,y.prototype._buffered_msg_queue=null,y.prototype._connectTimeout=null,y.prototype.sendPinger=null,y.prototype.receivePinger=null,y.prototype._reconnectInterval=1,y.prototype._reconnecting=!1,y.prototype._reconnectTimeout=null,y.prototype.disconnectedPublishing=!1,y.prototype.disconnectedBufferSize=5e3,y.prototype.receiveBuffer=null,y.prototype._traceBuffer=null,y.prototype._MAX_TRACE_ENTRIES=100,y.prototype.connect=function(o){var a=this._traceMask(o,"password");if(this._trace("Client.connect",a,this.socket,this.connected),this.connected)throw new Error(m(h.INVALID_STATE,["already connected"]));if(this.socket)throw new Error(m(h.INVALID_STATE,["already connected"]));this._reconnecting&&(this._reconnectTimeout.cancel(),this._reconnectTimeout=null,this._reconnecting=!1),this.connectOptions=o,this._reconnectInterval=1,this._reconnecting=!1,o.uris?(this.hostIndex=0,this._doConnect(o.uris[0])):this._doConnect(this.uri)},y.prototype.subscribe=function(o,a){if(this._trace("Client.subscribe",o,a),!this.connected)throw new Error(m(h.INVALID_STATE,["not connected"]));var u=new M(l.SUBSCRIBE);u.topics=o.constructor===Array?o:[o],a.qos===void 0&&(a.qos=0),u.requestedQos=[];for(var f=0;f<u.topics.length;f++)u.requestedQos[f]=a.qos;a.onSuccess&&(u.onSuccess=function(_){a.onSuccess({invocationContext:a.invocationContext,grantedQos:_})}),a.onFailure&&(u.onFailure=function(_){a.onFailure({invocationContext:a.invocationContext,errorCode:_,errorMessage:m(_)})}),a.timeout&&(u.timeOut=new z(this,a.timeout,a.onFailure,[{invocationContext:a.invocationContext,errorCode:h.SUBSCRIBE_TIMEOUT.code,errorMessage:m(h.SUBSCRIBE_TIMEOUT)}])),this._requires_ack(u),this._schedule_message(u)},y.prototype.unsubscribe=function(o,a){if(this._trace("Client.unsubscribe",o,a),!this.connected)throw new Error(m(h.INVALID_STATE,["not connected"]));var u=new M(l.UNSUBSCRIBE);u.topics=o.constructor===Array?o:[o],a.onSuccess&&(u.callback=function(){a.onSuccess({invocationContext:a.invocationContext})}),a.timeout&&(u.timeOut=new z(this,a.timeout,a.onFailure,[{invocationContext:a.invocationContext,errorCode:h.UNSUBSCRIBE_TIMEOUT.code,errorMessage:m(h.UNSUBSCRIBE_TIMEOUT)}])),this._requires_ack(u),this._schedule_message(u)},y.prototype.send=function(o){this._trace("Client.send",o);var a=new M(l.PUBLISH);if(a.payloadMessage=o,this.connected)o.qos>0?this._requires_ack(a):this.onMessageDelivered&&(this._notify_msg_sent[a]=this.onMessageDelivered(a.payloadMessage)),this._schedule_message(a);else if(this._reconnecting&&this.disconnectedPublishing){var u=Object.keys(this._sentMessages).length+this._buffered_msg_queue.length;if(u>this.disconnectedBufferSize)throw new Error(m(h.BUFFER_FULL,[this.disconnectedBufferSize]));o.qos>0?this._requires_ack(a):(a.sequence=++this._sequence,this._buffered_msg_queue.unshift(a))}else throw new Error(m(h.INVALID_STATE,["not connected"]))},y.prototype.disconnect=function(){if(this._trace("Client.disconnect"),this._reconnecting&&(this._reconnectTimeout.cancel(),this._reconnectTimeout=null,this._reconnecting=!1),!this.socket)throw new Error(m(h.INVALID_STATE,["not connecting or connected"]));var o=new M(l.DISCONNECT);this._notify_msg_sent[o]=I(this._disconnected,this),this._schedule_message(o)},y.prototype.getTraceLog=function(){if(this._traceBuffer!==null){this._trace("Client.getTraceLog",new Date),this._trace("Client.getTraceLog in flight messages",this._sentMessages.length);for(var o in this._sentMessages)this._trace("_sentMessages ",o,this._sentMessages[o]);for(var o in this._receivedMessages)this._trace("_receivedMessages ",o,this._receivedMessages[o]);return this._traceBuffer}},y.prototype.startTrace=function(){this._traceBuffer===null&&(this._traceBuffer=[]),this._trace("Client.startTrace",new Date,s)},y.prototype.stopTrace=function(){delete this._traceBuffer},y.prototype._doConnect=function(o){if(this.connectOptions.useSSL){var a=o.split(":");a[0]="wss",o=a.join(":")}this._wsuri=o,this.connected=!1,this.connectOptions.mqttVersion<4?this.socket=new WebSocket(o,["mqttv3.1"]):this.socket=new WebSocket(o,["mqtt"]),this.socket.binaryType="arraybuffer",this.socket.onopen=I(this._on_socket_open,this),this.socket.onmessage=I(this._on_socket_message,this),this.socket.onerror=I(this._on_socket_error,this),this.socket.onclose=I(this._on_socket_close,this),this.sendPinger=new Ne(this,this.connectOptions.keepAliveInterval),this.receivePinger=new Ne(this,this.connectOptions.keepAliveInterval),this._connectTimeout&&(this._connectTimeout.cancel(),this._connectTimeout=null),this._connectTimeout=new z(this,this.connectOptions.timeout,this._disconnected,[h.CONNECT_TIMEOUT.code,m(h.CONNECT_TIMEOUT)])},y.prototype._schedule_message=function(o){this._msg_queue.unshift(o),this.connected&&this._process_queue()},y.prototype.store=function(o,a){var u={type:a.type,messageIdentifier:a.messageIdentifier,version:1};switch(a.type){case l.PUBLISH:a.pubRecReceived&&(u.pubRecReceived=!0),u.payloadMessage={};for(var f="",_=a.payloadMessage.payloadBytes,p=0;p<_.length;p++)_[p]<=15?f=f+"0"+_[p].toString(16):f=f+_[p].toString(16);u.payloadMessage.payloadHex=f,u.payloadMessage.qos=a.payloadMessage.qos,u.payloadMessage.destinationName=a.payloadMessage.destinationName,a.payloadMessage.duplicate&&(u.payloadMessage.duplicate=!0),a.payloadMessage.retained&&(u.payloadMessage.retained=!0),o.indexOf("Sent:")===0&&(a.sequence===void 0&&(a.sequence=++this._sequence),u.sequence=a.sequence);break;default:throw Error(m(h.INVALID_STORED_DATA,[o+this._localKey+a.messageIdentifier,u]))}c.setItem(o+this._localKey+a.messageIdentifier,JSON.stringify(u))},y.prototype.restore=function(o){var a=c.getItem(o),u=JSON.parse(a),f=new M(u.type,u);switch(u.type){case l.PUBLISH:for(var _=u.payloadMessage.payloadHex,p=new ArrayBuffer(_.length/2),v=new Uint8Array(p),S=0;_.length>=2;){var w=parseInt(_.substring(0,2),16);_=_.substring(2,_.length),v[S++]=w}var R=new G(v);R.qos=u.payloadMessage.qos,R.destinationName=u.payloadMessage.destinationName,u.payloadMessage.duplicate&&(R.duplicate=!0),u.payloadMessage.retained&&(R.retained=!0),f.payloadMessage=R;break;default:throw Error(m(h.INVALID_STORED_DATA,[o,a]))}o.indexOf("Sent:"+this._localKey)===0?(f.payloadMessage.duplicate=!0,this._sentMessages[f.messageIdentifier]=f):o.indexOf("Received:"+this._localKey)===0&&(this._receivedMessages[f.messageIdentifier]=f)},y.prototype._process_queue=function(){for(var o=null;o=this._msg_queue.pop();)this._socket_send(o),this._notify_msg_sent[o]&&(this._notify_msg_sent[o](),delete this._notify_msg_sent[o])},y.prototype._requires_ack=function(o){var a=Object.keys(this._sentMessages).length;if(a>this.maxMessageIdentifier)throw Error("Too many messages:"+a);for(;this._sentMessages[this._message_identifier]!==void 0;)this._message_identifier++;o.messageIdentifier=this._message_identifier,this._sentMessages[o.messageIdentifier]=o,o.type===l.PUBLISH&&this.store("Sent:",o),this._message_identifier===this.maxMessageIdentifier&&(this._message_identifier=1)},y.prototype._on_socket_open=function(){var o=new M(l.CONNECT,this.connectOptions);o.clientId=this.clientId,this._socket_send(o)},y.prototype._on_socket_message=function(o){this._trace("Client._on_socket_message",o.data);for(var a=this._deframeMessages(o.data),u=0;u<a.length;u+=1)this._handleMessage(a[u])},y.prototype._deframeMessages=function(o){var a=new Uint8Array(o),u=[];if(this.receiveBuffer){var f=new Uint8Array(this.receiveBuffer.length+a.length);f.set(this.receiveBuffer),f.set(a,this.receiveBuffer.length),a=f,delete this.receiveBuffer}try{for(var _=0;_<a.length;){var p=me(a,_),v=p[0];if(_=p[1],v!==null)u.push(v);else break}_<a.length&&(this.receiveBuffer=a.subarray(_))}catch(w){var S=w.hasOwnProperty("stack")=="undefined"?w.stack.toString():"No Error Stack Available";this._disconnected(h.INTERNAL_ERROR.code,m(h.INTERNAL_ERROR,[w.message,S]));return}return u},y.prototype._handleMessage=function(o){this._trace("Client._handleMessage",o);try{switch(o.type){case l.CONNACK:if(this._connectTimeout.cancel(),this._reconnectTimeout&&this._reconnectTimeout.cancel(),this.connectOptions.cleanSession){for(var a in this._sentMessages){var d=this._sentMessages[a];c.removeItem("Sent:"+this._localKey+d.messageIdentifier)}this._sentMessages={};for(var a in this._receivedMessages){var R=this._receivedMessages[a];c.removeItem("Received:"+this._localKey+R.messageIdentifier)}this._receivedMessages={}}if(o.returnCode===0)this.connected=!0,this.connectOptions.uris&&(this.hostIndex=this.connectOptions.uris.length);else{this._disconnected(h.CONNACK_RETURNCODE.code,m(h.CONNACK_RETURNCODE,[o.returnCode,N[o.returnCode]]));break}var _=[];for(var u in this._sentMessages)this._sentMessages.hasOwnProperty(u)&&_.push(this._sentMessages[u]);if(this._buffered_msg_queue.length>0)for(var f=null;f=this._buffered_msg_queue.pop();)_.push(f),this.onMessageDelivered&&(this._notify_msg_sent[f]=this.onMessageDelivered(f.payloadMessage));for(var _=_.sort(function(b,L){return b.sequence-L.sequence}),p=0,v=_.length;p<v;p++){var d=_[p];if(d.type==l.PUBLISH&&d.pubRecReceived){var S=new M(l.PUBREL,{messageIdentifier:d.messageIdentifier});this._schedule_message(S)}else this._schedule_message(d)}this.connectOptions.onSuccess&&this.connectOptions.onSuccess({invocationContext:this.connectOptions.invocationContext});var w=!1;this._reconnecting&&(w=!0,this._reconnectInterval=1,this._reconnecting=!1),this._connected(w,this._wsuri),this._process_queue();break;case l.PUBLISH:this._receivePublish(o);break;case l.PUBACK:var d=this._sentMessages[o.messageIdentifier];d&&(delete this._sentMessages[o.messageIdentifier],c.removeItem("Sent:"+this._localKey+o.messageIdentifier),this.onMessageDelivered&&this.onMessageDelivered(d.payloadMessage));break;case l.PUBREC:var d=this._sentMessages[o.messageIdentifier];if(d){d.pubRecReceived=!0;var S=new M(l.PUBREL,{messageIdentifier:o.messageIdentifier});this.store("Sent:",d),this._schedule_message(S)}break;case l.PUBREL:var R=this._receivedMessages[o.messageIdentifier];c.removeItem("Received:"+this._localKey+o.messageIdentifier),R&&(this._receiveMessage(R),delete this._receivedMessages[o.messageIdentifier]);var E=new M(l.PUBCOMP,{messageIdentifier:o.messageIdentifier});this._schedule_message(E);break;case l.PUBCOMP:var d=this._sentMessages[o.messageIdentifier];delete this._sentMessages[o.messageIdentifier],c.removeItem("Sent:"+this._localKey+o.messageIdentifier),this.onMessageDelivered&&this.onMessageDelivered(d.payloadMessage);break;case l.SUBACK:var d=this._sentMessages[o.messageIdentifier];d&&(d.timeOut&&d.timeOut.cancel(),o.returnCode[0]===128?d.onFailure&&d.onFailure(o.returnCode):d.onSuccess&&d.onSuccess(o.returnCode),delete this._sentMessages[o.messageIdentifier]);break;case l.UNSUBACK:var d=this._sentMessages[o.messageIdentifier];d&&(d.timeOut&&d.timeOut.cancel(),d.callback&&d.callback(),delete this._sentMessages[o.messageIdentifier]);break;case l.PINGRESP:this.sendPinger.reset();break;case l.DISCONNECT:this._disconnected(h.INVALID_MQTT_MESSAGE_TYPE.code,m(h.INVALID_MQTT_MESSAGE_TYPE,[o.type]));break;default:this._disconnected(h.INVALID_MQTT_MESSAGE_TYPE.code,m(h.INVALID_MQTT_MESSAGE_TYPE,[o.type]))}}catch(b){var A=b.hasOwnProperty("stack")=="undefined"?b.stack.toString():"No Error Stack Available";this._disconnected(h.INTERNAL_ERROR.code,m(h.INTERNAL_ERROR,[b.message,A]));return}},y.prototype._on_socket_error=function(o){this._reconnecting||this._disconnected(h.SOCKET_ERROR.code,m(h.SOCKET_ERROR,[o.data]))},y.prototype._on_socket_close=function(){this._reconnecting||this._disconnected(h.SOCKET_CLOSE.code,m(h.SOCKET_CLOSE))},y.prototype._socket_send=function(o){if(o.type==1){var a=this._traceMask(o,"password");this._trace("Client._socket_send",a)}else this._trace("Client._socket_send",o);this.socket.send(o.encode()),this.sendPinger.reset()},y.prototype._receivePublish=function(o){switch(o.payloadMessage.qos){case"undefined":case 0:this._receiveMessage(o);break;case 1:var a=new M(l.PUBACK,{messageIdentifier:o.messageIdentifier});this._schedule_message(a),this._receiveMessage(o);break;case 2:this._receivedMessages[o.messageIdentifier]=o,this.store("Received:",o);var u=new M(l.PUBREC,{messageIdentifier:o.messageIdentifier});this._schedule_message(u);break;default:throw Error("Invaild qos="+o.payloadMessage.qos)}},y.prototype._receiveMessage=function(o){this.onMessageArrived&&this.onMessageArrived(o.payloadMessage)},y.prototype._connected=function(o,a){this.onConnected&&this.onConnected(o,a)},y.prototype._reconnect=function(){this._trace("Client._reconnect"),this.connected||(this._reconnecting=!0,this.sendPinger.cancel(),this.receivePinger.cancel(),this._reconnectInterval<128&&(this._reconnectInterval=this._reconnectInterval*2),this.connectOptions.uris?(this.hostIndex=0,this._doConnect(this.connectOptions.uris[0])):this._doConnect(this.uri))},y.prototype._disconnected=function(o,a){if(this._trace("Client._disconnected",o,a),o!==void 0&&this._reconnecting){this._reconnectTimeout=new z(this,this._reconnectInterval,this._reconnect);return}if(this.sendPinger.cancel(),this.receivePinger.cancel(),this._connectTimeout&&(this._connectTimeout.cancel(),this._connectTimeout=null),this._msg_queue=[],this._buffered_msg_queue=[],this._notify_msg_sent={},this.socket&&(this.socket.onopen=null,this.socket.onmessage=null,this.socket.onerror=null,this.socket.onclose=null,this.socket.readyState===1&&this.socket.close(),delete this.socket),this.connectOptions.uris&&this.hostIndex<this.connectOptions.uris.length-1)this.hostIndex++,this._doConnect(this.connectOptions.uris[this.hostIndex]);else if(o===void 0&&(o=h.OK.code,a=m(h.OK)),this.connected){if(this.connected=!1,this.onConnectionLost&&this.onConnectionLost({errorCode:o,errorMessage:a,reconnect:this.connectOptions.reconnect,uri:this._wsuri}),o!==h.OK.code&&this.connectOptions.reconnect){this._reconnectInterval=1,this._reconnect();return}}else this.connectOptions.mqttVersion===4&&this.connectOptions.mqttVersionExplicit===!1?(this._trace("Failed to connect V4, dropping back to V3"),this.connectOptions.mqttVersion=3,this.connectOptions.uris?(this.hostIndex=0,this._doConnect(this.connectOptions.uris[0])):this._doConnect(this.uri)):this.connectOptions.onFailure&&this.connectOptions.onFailure({invocationContext:this.connectOptions.invocationContext,errorCode:o,errorMessage:a})},y.prototype._trace=function(){if(this.traceFunction){var o=Array.prototype.slice.call(arguments);for(var a in o)typeof o[a]<"u"&&o.splice(a,1,JSON.stringify(o[a]));var u=o.join("");this.traceFunction({severity:"Debug",message:u})}if(this._traceBuffer!==null)for(var a=0,f=arguments.length;a<f;a++)this._traceBuffer.length==this._MAX_TRACE_ENTRIES&&this._traceBuffer.shift(),a===0?this._traceBuffer.push(arguments[a]):typeof arguments[a]>"u"?this._traceBuffer.push(arguments[a]):this._traceBuffer.push("  "+JSON.stringify(arguments[a]))},y.prototype._traceMask=function(o,a){var u={};for(var f in o)o.hasOwnProperty(f)&&(f==a?u[f]="******":u[f]=o[f]);return u};var xn=function(o,a,u,f){var _;if(typeof o!="string")throw new Error(m(h.INVALID_TYPE,[typeof o,"host"]));if(arguments.length==2){f=a,_=o;var p=_.match(/^(wss?):\/\/((\[(.+)\])|([^\/]+?))(:(\d+))?(\/.*)$/);if(p)o=p[4]||p[2],a=parseInt(p[7]),u=p[8];else throw new Error(m(h.INVALID_ARGUMENT,[o,"host"]))}else{if(arguments.length==3&&(f=u,u="/mqtt"),typeof a!="number"||a<0)throw new Error(m(h.INVALID_TYPE,[typeof a,"port"]));if(typeof u!="string")throw new Error(m(h.INVALID_TYPE,[typeof u,"path"]));var v=o.indexOf(":")!==-1&&o.slice(0,1)!=="["&&o.slice(-1)!=="]";_="ws://"+(v?"["+o+"]":o)+":"+a+u}for(var S=0,w=0;w<f.length;w++){var R=f.charCodeAt(w);55296<=R&&R<=56319&&w++,S++}if(typeof f!="string"||S>65535)throw new Error(m(h.INVALID_ARGUMENT,[f,"clientId"]));var E=new y(_,o,a,u,f);Object.defineProperties(this,{host:{get:function(){return o},set:function(){throw new Error(m(h.UNSUPPORTED_OPERATION))}},port:{get:function(){return a},set:function(){throw new Error(m(h.UNSUPPORTED_OPERATION))}},path:{get:function(){return u},set:function(){throw new Error(m(h.UNSUPPORTED_OPERATION))}},uri:{get:function(){return _},set:function(){throw new Error(m(h.UNSUPPORTED_OPERATION))}},clientId:{get:function(){return E.clientId},set:function(){throw new Error(m(h.UNSUPPORTED_OPERATION))}},onConnected:{get:function(){return E.onConnected},set:function(d){if(typeof d=="function")E.onConnected=d;else throw new Error(m(h.INVALID_TYPE,[typeof d,"onConnected"]))}},disconnectedPublishing:{get:function(){return E.disconnectedPublishing},set:function(d){E.disconnectedPublishing=d}},disconnectedBufferSize:{get:function(){return E.disconnectedBufferSize},set:function(d){E.disconnectedBufferSize=d}},onConnectionLost:{get:function(){return E.onConnectionLost},set:function(d){if(typeof d=="function")E.onConnectionLost=d;else throw new Error(m(h.INVALID_TYPE,[typeof d,"onConnectionLost"]))}},onMessageDelivered:{get:function(){return E.onMessageDelivered},set:function(d){if(typeof d=="function")E.onMessageDelivered=d;else throw new Error(m(h.INVALID_TYPE,[typeof d,"onMessageDelivered"]))}},onMessageArrived:{get:function(){return E.onMessageArrived},set:function(d){if(typeof d=="function")E.onMessageArrived=d;else throw new Error(m(h.INVALID_TYPE,[typeof d,"onMessageArrived"]))}},trace:{get:function(){return E.traceFunction},set:function(d){if(typeof d=="function")E.traceFunction=d;else throw new Error(m(h.INVALID_TYPE,[typeof d,"onTrace"]))}}}),this.connect=function(d){if(d=d||{},g(d,{timeout:"number",userName:"string",password:"string",willMessage:"object",keepAliveInterval:"number",cleanSession:"boolean",useSSL:"boolean",invocationContext:"object",onSuccess:"function",onFailure:"function",hosts:"object",ports:"object",reconnect:"boolean",mqttVersion:"number",mqttVersionExplicit:"boolean",uris:"object"}),d.keepAliveInterval===void 0&&(d.keepAliveInterval=60),d.mqttVersion>4||d.mqttVersion<3)throw new Error(m(h.INVALID_ARGUMENT,[d.mqttVersion,"connectOptions.mqttVersion"]));if(d.mqttVersion===void 0?(d.mqttVersionExplicit=!1,d.mqttVersion=4):d.mqttVersionExplicit=!0,d.password!==void 0&&d.userName===void 0)throw new Error(m(h.INVALID_ARGUMENT,[d.password,"connectOptions.password"]));if(d.willMessage){if(!(d.willMessage instanceof G))throw new Error(m(h.INVALID_TYPE,[d.willMessage,"connectOptions.willMessage"]));if(d.willMessage.stringPayload=null,typeof d.willMessage.destinationName>"u")throw new Error(m(h.INVALID_TYPE,[typeof d.willMessage.destinationName,"connectOptions.willMessage.destinationName"]))}if(typeof d.cleanSession>"u"&&(d.cleanSession=!0),d.hosts){if(!(d.hosts instanceof Array))throw new Error(m(h.INVALID_ARGUMENT,[d.hosts,"connectOptions.hosts"]));if(d.hosts.length<1)throw new Error(m(h.INVALID_ARGUMENT,[d.hosts,"connectOptions.hosts"]));for(var A=!1,b=0;b<d.hosts.length;b++){if(typeof d.hosts[b]!="string")throw new Error(m(h.INVALID_TYPE,[typeof d.hosts[b],"connectOptions.hosts["+b+"]"]));if(/^(wss?):\/\/((\[(.+)\])|([^\/]+?))(:(\d+))?(\/.*)$/.test(d.hosts[b])){if(b===0)A=!0;else if(!A)throw new Error(m(h.INVALID_ARGUMENT,[d.hosts[b],"connectOptions.hosts["+b+"]"]))}else if(A)throw new Error(m(h.INVALID_ARGUMENT,[d.hosts[b],"connectOptions.hosts["+b+"]"]))}if(A)d.uris=d.hosts;else{if(!d.ports)throw new Error(m(h.INVALID_ARGUMENT,[d.ports,"connectOptions.ports"]));if(!(d.ports instanceof Array))throw new Error(m(h.INVALID_ARGUMENT,[d.ports,"connectOptions.ports"]));if(d.hosts.length!==d.ports.length)throw new Error(m(h.INVALID_ARGUMENT,[d.ports,"connectOptions.ports"]));d.uris=[];for(var b=0;b<d.hosts.length;b++){if(typeof d.ports[b]!="number"||d.ports[b]<0)throw new Error(m(h.INVALID_TYPE,[typeof d.ports[b],"connectOptions.ports["+b+"]"]));var L=d.hosts[b],C=d.ports[b],Bn=L.indexOf(":")!==-1;_="ws://"+(Bn?"["+L+"]":L)+":"+C+u,d.uris.push(_)}}}E.connect(d)},this.subscribe=function(d,A){if(typeof d!="string"&&d.constructor!==Array)throw new Error("Invalid argument:"+d);if(A=A||{},g(A,{qos:"number",invocationContext:"object",onSuccess:"function",onFailure:"function",timeout:"number"}),A.timeout&&!A.onFailure)throw new Error("subscribeOptions.timeout specified with no onFailure callback.");if(typeof A.qos<"u"&&!(A.qos===0||A.qos===1||A.qos===2))throw new Error(m(h.INVALID_ARGUMENT,[A.qos,"subscribeOptions.qos"]));E.subscribe(d,A)},this.unsubscribe=function(d,A){if(typeof d!="string"&&d.constructor!==Array)throw new Error("Invalid argument:"+d);if(A=A||{},g(A,{invocationContext:"object",onSuccess:"function",onFailure:"function",timeout:"number"}),A.timeout&&!A.onFailure)throw new Error("unsubscribeOptions.timeout specified with no onFailure callback.");E.unsubscribe(d,A)},this.send=function(d,A,b,L){var C;if(arguments.length===0)throw new Error("Invalid argument.length");if(arguments.length==1){if(!(d instanceof G)&&typeof d!="string")throw new Error("Invalid argument:"+typeof d);if(C=d,typeof C.destinationName>"u")throw new Error(m(h.INVALID_ARGUMENT,[C.destinationName,"Message.destinationName"]));E.send(C)}else C=new G(A),C.destinationName=d,arguments.length>=3&&(C.qos=b),arguments.length>=4&&(C.retained=L),E.send(C)},this.publish=function(d,A,b,L){var C;if(arguments.length===0)throw new Error("Invalid argument.length");if(arguments.length==1){if(!(d instanceof G)&&typeof d!="string")throw new Error("Invalid argument:"+typeof d);if(C=d,typeof C.destinationName>"u")throw new Error(m(h.INVALID_ARGUMENT,[C.destinationName,"Message.destinationName"]));E.send(C)}else C=new G(A),C.destinationName=d,arguments.length>=3&&(C.qos=b),arguments.length>=4&&(C.retained=L),E.send(C)},this.disconnect=function(){E.disconnect()},this.getTraceLog=function(){return E.getTraceLog()},this.startTrace=function(){E.startTrace()},this.stopTrace=function(){E.stopTrace()},this.isConnected=function(){return E.connected}},G=function(o){var a;if(typeof o=="string"||o instanceof ArrayBuffer||ArrayBuffer.isView(o)&&!(o instanceof DataView))a=o;else throw m(h.INVALID_ARGUMENT,[o,"newPayload"]);var u,f=0,_=!1,p=!1;Object.defineProperties(this,{payloadString:{enumerable:!0,get:function(){return typeof a=="string"?a:ve(a,0,a.length)}},payloadBytes:{enumerable:!0,get:function(){if(typeof a=="string"){var v=new ArrayBuffer(D(a)),S=new Uint8Array(v);return ue(a,S,0),S}else return a}},destinationName:{enumerable:!0,get:function(){return u},set:function(v){if(typeof v=="string")u=v;else throw new Error(m(h.INVALID_ARGUMENT,[v,"newDestinationName"]))}},qos:{enumerable:!0,get:function(){return f},set:function(v){if(v===0||v===1||v===2)f=v;else throw new Error("Invalid argument:"+v)}},retained:{enumerable:!0,get:function(){return _},set:function(v){if(typeof v=="boolean")_=v;else throw new Error(m(h.INVALID_ARGUMENT,[v,"newRetained"]))}},topic:{enumerable:!0,get:function(){return u},set:function(v){u=v}},duplicate:{enumerable:!0,get:function(){return p},set:function(v){p=v}}})};return{Client:xn,Message:G}}(typeof it<"u"?it:typeof self<"u"?self:typeof window<"u"?window:{});return i})})(Eo);class wo{constructor(e){ie(this,"onConnectionLost",e=>{console.log("onConnectionLost (TODO: reconnect?)",e),this.connectStatus="Disconnected",e.errorCode!==0&&console.log("onConnectionLost:"+e.errorMessage),this.onMQTTLost&&this.onMQTTLost(e)});ie(this,"connect",()=>{const e="incharge.one",i="web_"+this.id,r=!0,s=3;this.client=new He.Client(e,443,i),this.client.onConnectionLost=this.onConnectionLost,this.client.onMessageArrived=c=>{console.log("onMessageArrived",c);try{this.data=JSON.parse(c.payloadString),this.onMessageArrived&&this.onMessageArrived(this.data)}catch(l){console.log("error",l)}},console.log("Connecting...."),this.client.connect({useSSL:r,reconnect:!0,onSuccess:()=>{console.log("Connected"),this.connectStatus="Connected",this.client.subscribe("charger/"+this.id+"/status"),this.onMQTTConnect&&this.onMQTTConnect()},onFailure:c=>{console.log("Connection failed",c),this.connectStatus="Connection failed"},timeout:s})});ie(this,"subscribe",(e,t=0)=>{if(!this.client){console.log("client is not connected");return}this.client.subscribe(e,{qos:t})});ie(this,"publish",(e,t,i=0,r=!1)=>{if(!this.client){console.log("client is not connected");return}console.log("publish",e,t,i,r);const s=new He.Message(t);s.destinationName=e,s.qos=i,s.retained=r,this.client.send(s)});ie(this,"disconnect",()=>{if(!this.client){console.log("client is not connected");return}this.client.disconnect(),this.client=null});ie(this,"isConnected",()=>this.client&&this.client.isConnected());this.id=e,this.client=null,this.connectStatus="Disconnected",this.onMQTTConnect=null,this.onMQTTLost=null,this.onMessageArrived=null,this.data={}}}const re=window.location.hash.slice(1);window.onhashchange=function(){window.location.reload()};const To=n=>{n.innerHTML=`
    <div>
...
`,Je=(n,e,t,i,r,s)=>{n.innerHTML=`
  ...
  `,Un(document.querySelector(".logout"),i),Po(document.querySelector("#balance"))},Et=(n,e,t,i,r,s)=>{n.innerHTML=`
    <div class="header">
  ...
  `),n.querySelector("#stop_charging").addEventListener("click",c)},$o=(n,e,t,i,r,s)=>{var l,g,I,h;const c=N=>{console.log("User connected to charger"),r.publish(`charger/${e}/commands`,`stop:${t.uid}`)};Et(n,e,t,i,r,`
    <div>
  ...
  `),n.querySelector("#stop_charging").addEventListener("click",c)},Ho=(n,e,t,i,r,s)=>{var c;Et(n,e,t,i,r,`
    <div>
      <h2>Заряджання завершено.</h2>
    </div>
    <div>
      <div><span>Спожито: </span><span id="energy">${(c=s.energy)==null?void 0:c.toFixed(0)}</span> <span>Wh</span></div>
    </div>
    <div>
      <div><span>Час заряджання: </span><span id="time">${((s.time||0)/60).toFixed(0)}</span> <span>хв</span></div>
    </div>
  ...
  `),n.querySelector("#stop_charging").addEventListener("click",stopCharging)},qo=(n,e,t,i)=>{n.innerHTML=`
...
`},jo=(n,e,t)=>{n.innerHTML=`
  ...
  `},Go=(n,e)=>{let t=e;e==="fwupdate"&&(t="Перезавантаження для оновлення ПЗ"),n.innerHTML=`
    <div class="charger">
      <img src="${te}" class="logo" alt="Vite logo" />
  ...
  `},Ko=(n,e,t)=>{let i="Інше";e==="fwupdate"&&(i="Оновлення ПЗ"),n.innerHTML=`
    <div class="charger">
      <img src="${te}" class="logo" alt="Vite logo" />
  ...
  `},Jo=(n,e,t,i,r)=>{const s=t.uid;console.log("---- uid=",s),console.log("charger=",Co);let c=setTimeout(()=>{xo(n,e,t,i,r)},15e3);r.onMessageArrived=l=>{if(console.log("onMessageArrived",l),clearTimeout(c),l.uid&&l.uid!==s)return zo(n);switch(l.status){case"init":Bo(n,e,t,i,r);break;case"ready":Fo(n,e,t,i,r);break;case"busy":Vo(n,e,t,i,r,l);break;case"charging":$o(n,e,t,i,r,l);break;case"done":Ho(n,e,t,i,r,l);break;case"error":jo(n,l.code,l.reason);break;case"off":Go(n,l.reason);break;case"maintenance":Ko(n,l.event,l.message);break;case"ignore_me":break;default:qo(n)}},Uo(n,e,t,i,r)},Qo=document.getElementById("app"),Yo=n=>{if(console.log("App:element",n),!re)return To(n);const e=new yo,t=new wo("charger_"+re);t.onMQTTConnect=()=>{console.log("onMQTTConnect"),t.subscribe("charger/"+re+"/status"),t.subscribe("charger/"+re+"/data");const i=e.getCurrentUser();i&&t.publish("charger/"+re+"/commands",`hello:${i.uid}`)},t.onMQTTLost=()=>(console.log("onMQTTLost. TODO: reconnect"),Wo(n)),e.onAuthStateChanged(i=>(console.log("user=",i),i?(t.id="charger_"+re+"_"+i.uid,t.connect(),Jo(n,re,i,e,t)):(t.disconnect(),So(n,e))))};Yo(Qo);
