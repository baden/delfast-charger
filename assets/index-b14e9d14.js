 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function P(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function lr(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(P())}function ur(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function dr(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function hr(){const t=P();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function Ln(){try{return typeof indexedDB=="object"}catch{return!1}}function Un(){return new Promise((t,e)=>{try{let n=!0;const i="validate-browser-context-for-indexeddb-analytics-module",r=self.indexedDB.open(i);r.onsuccess=()=>{r.result.close(),n||self.indexedDB.deleteDatabase(i),t(!0)},r.onupgradeneeded=()=>{n=!1},r.onerror=()=>{var s;e(((s=r.error)===null||s===void 0?void 0:s.message)||"")}}catch(n){e(n)}})}function fr(){return!(typeof navigator>"u"||!navigator.cookieEnabled)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rs(t,e){const n=Pe(t,"auth");if(n.isInitialized()){const r=n.getImmediate(),s=n.getOptions();if(je(s,e??{}))return r;H(r,"already-initialized")}return n.initialize({options:e})}function Ns(t,e){const n=(e==null?void 0:e.persistence)||[],i=(Array.isArray(n)?n:[n]).map(z);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(i,e==null?void 0:e.popupRedirectResolver)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Os(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(Ms()||ur()||"connection"in navigator)?navigator.onLine:!0}function Ps(){if(typeof navigator>"u")return null;const t=navigator;return t.languages&&t.languages[0]||t.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class De{constructor(e,n){this.shortDelay=e,this.longDelay=n,Y(n>e,"Short delay should be less than long delay!"),this.isMobile=lr()||dr()}get(){return Os()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zs(t,e){const n=await zn(t,{},async()=>{const i=Oe({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:r,apiKey:s}=t.config,o=Jn(t,r,"/v1/token",`key=${s}`),l=await t._getAdditionalHeaders();return l["Content-Type"]="application/x-www-form-urlencoded",Gn.fetch()(o,{method:"POST",headers:l,body:i})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ln(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(ei(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Xn(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(ni(e))return"Blackberry";if(ii(e))return"Webos";if(xt(e))return"Safari";if((e.includes("chrome/")||Zn(e))&&!e.includes("edge/"))return"Chrome";if(ti(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=t.match(n);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function Xn(t=P()){return/firefox\//i.test(t)}function xt(t=P()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Zn(t=P()){return/crios\//i.test(t)}function ei(t=P()){return/iemobile/i.test(t)}function ti(t=P()){return/android/i.test(t)}function ni(t=P()){return/blackberry/i.test(t)}function ii(t=P()){return/webos/i.test(t)}function tt(t=P()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function Js(t=P()){var e;return tt(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Qs(){return hr()&&document.documentMode===10}function ri(t=P()){return tt(t)||ti(t)||ii(t)||ni(t)||/windows phone/i.test(t)||ei(t)}function Ys(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function si(t,e=[]){let n;switch(t){case"Browser":n=ln(P());break;case"Worker":n=`${ln(P())}-${t}`;break;default:n=t}const i=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Ze}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vi{constructor(e,n,i,r,s=!1){this.auth=e,this.resolver=i,this.user=r,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:i,postBody:r,tenantId:s,error:o,type:l}=e;if(o){this.reject(o);return}const f={auth:this.auth,requestUri:n,sessionId:i,tenantId:s||void 0,postBody:r||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(f))}catch(_){this.reject(_)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return No;case"linkViaPopup":case"linkViaRedirect":return Oo;case"reauthViaPopup":case"reauthViaRedirect":return Mo;default:H(this.auth,"internal-error")}}resolve(e){Y(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Y(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wa=5*60,ba=Dn("authIdTokenMaxAge")||wa;let wn=null;const Ea=t=>async e=>{const n=e&&await e.getIdTokenResult(),i=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(i&&i>ba)return;const r=n==null?void 0:n.token;wn!==r&&(wn=r,await fetch(t,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function Ta(t=Vn()){const e=Pe(t,"auth");if(e.isInitialized())return e.getImmediate();const n=Rs(t,{popupRedirectResolver:_a,persistence:[Ao,po,hi]}),i=Dn("authTokenSyncURL");if(i){const s=Ea(i);co(n,s,()=>s(n.currentUser)),ao(n,o=>s(o))}const r=or("auth");return r&&eo(n,`http://${r}`),n}ya("Browser");const yi="@firebase/installations",Vt="0.6.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pa({appConfig:t,heartbeatServiceProvider:e},{fid:n}){const i=Si(t),r=Ci(t),s=e.getImmediate({optional:!0});if(s){const _=await s.getHeartbeatsHeader();_&&r.append("x-firebase-client",_)}const o={fid:n,authVersion:Ei,appId:t.appId,sdkVersion:bi},l={method:"POST",headers:r,body:JSON.stringify(o)},f=await Ri(()=>fetch(i,l));if(f.ok){const _=await f.json();return{fid:_.fid||n,registrationStatus:2,refreshToken:_.refreshToken,authToken:Ai(_.authToken)}}else throw await ki("Create Installation",f)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mi=new Map;function Oi(t,e){const n=st(t);Pi(n,e),Ba(n,e)}function Pi(t,e){const n=Mi.get(t);if(n)for(const i of n)i(e)}function Ba(t,e){const n=Fa();n&&n.postMessage({key:t,fid:e}),$a()}let fe=null;function Fa(){return!fe&&"BroadcastChannel"in self&&(fe=new BroadcastChannel("[Firebase] FID Change"),fe.onmessage=t=>{Pi(t.data.key,t.data.fid)}),fe}function $a(){Mi.size===0&&fe&&(fe.close(),fe=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xi="installations",oc="installations-internal",ac=t=>{const e=t.getProvider("app").getImmediate(),n=sc(e),i=Pe(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()}},cc=t=>{const e=t.getProvider("app").getImmediate(),n=Pe(e,xi).getImmediate();return{getId:()=>nc(n),getToken:r=>ic(n,r)}};function lc(){Q(new q(xi,ac,"PUBLIC")),Q(new q(oc,cc,"PRIVATE"))}lc();F(yi,Vt);F(yi,Vt,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Tc(t,e){const n=await Jt(t),i=qi(e),r={method:"POST",headers:n,body:JSON.stringify(i)};let s;try{s=await(await fetch(zt(t.appConfig),r)).json()}catch(o){throw O.create("token-subscribe-failed",{errorInfo:o==null?void 0:o.toString()})}if(s.error){const o=s.error.message;throw O.create("token-subscribe-failed",{errorInfo:o})}if(!s.token)throw O.create("token-subscribe-no-token");return s.token}async function Sc(t,e){const n=await Jt(t),i=qi(e.subscriptionOptions),r={method:"PATCH",headers:n,body:JSON.stringify(i)};let s;try{s=await(await fetch(`${zt(t.appConfig)}/${e.token}`,r)).json()}catch(o){throw O.create("token-update-failed",{errorInfo:o==null?void 0:o.toString()})}if(s.error){const o=s.error.message;throw O.create("token-update-failed",{errorInfo:o})}if(!s.token)throw O.create("token-update-no-token");return s.token}async function Vi(t,e){const i={method:"DELETE",headers:await Jt(t)};try{const s=await(await fetch(`${zt(t.appConfig)}/${e}`,i)).json();if(s.error){const o=s.error.message;throw O.create("token-unsubscribe-failed",{errorInfo:o})}}catch(r){throw O.create("token-unsubscribe-failed",{errorInfo:r==null?void 0:r.toString()})}}function zt({projectId:t}){return`${hc}/projects/${t}/registrations`}async function Jt({appConfig:t,installations:e}){const n=await e.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t.apiKey,"x-goog-firebase-installations-auth":`FIS ${n}`})}function qi({p256dh:t,auth:e,endpoint:n,vapidKey:i}){const r={web:{endpoint:n,auth:e,p256dh:t}};return i!==Bi&&(r.web.applicationPubKey=i),r}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bc(t){try{t.swRegistration=await navigator.serviceWorker.register(uc,{scope:dc}),t.swRegistration.update().catch(()=>{})}catch(e){throw O.create("failed-service-worker-registration",{browserErrorMessage:e==null?void 0:e.message})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Fc(t,e){if(!e&&!t.swRegistration&&await Bc(t),!(!e&&t.swRegistration)){if(!(e instanceof ServiceWorkerRegistration))throw O.create("invalid-sw-registration");t.swRegistration=e}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ji(t,e){if(!navigator)throw O.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw O.create("permission-blocked");return await $c(t,e==null?void 0:e.vapidKey),await Fc(t,e==null?void 0:e.serviceWorkerRegistration),kc(t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zc(t,e){if(!navigator)throw O.create("only-available-in-window");return t.onMessageHandler=e,()=>{t.onMessageHandler=null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`},Al=(t,e,n)=>{t.innerHTML=`
  ...
  `},Nl=(t,e,n,i,r)=>{const s=n.uid;console.log("---- uid=",s),console.log("charger=",cl);let o=setTimeout(()=>{_l(t,e,n,i,r)},15e3);r.onMessageArrived=l=>{if(clearTimeout(o),l.uid&&l.uid!==s)return kl(t);switch(l.status){case"init":vl(t,e,n,i,r);break;case"ready":Il(t,e,n,i,r);break;case"busy":yl(t,e,n,i,r,l);break;case"charging":wl(t,e,n,i,r,l);break;case"completed":bl(t,e,n,i,r,l);break;case"done":El(t,e,n,i,r,l);break;case"error":Al(t,l.code,l.reason);break;case"off":Cl(t,l.reason);break;case"maintenance":Rl(t,l.event,l.message);break;case"ignore_me":break;default:Tl(t)}},ml(t,e,n,i,r)},Ml=document.getElementById("app"),Ol=t=>{if(console.log("App:element",t),!ue)return rl(t);const e=new tl;e.requestPermission();const n=new il("charger_"+ue);n.onMQTTConnect=()=>{console.log("onMQTTConnect"),n.subscribe("charger/"+ue+"/status"),n.subscribe("charger/"+ue+"/data");const i=e.getCurrentUser();i&&n.publish("charger/"+ue+"/commands",`hello:${i.uid}`)},n.onMQTTLost=()=>(console.log("onMQTTLost. TODO: reconnect"),Sl(t)),e.onAuthStateChanged(i=>(console.log("user=",i),i?(n.id="charger_"+ue+"_"+i.uid,n.connect(),Nl(t,ue,i,e,n)):(n.disconnect(),ol(t,e))))};Ol(Ml);
