 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ii="FirebaseError";class ee extends Error{constructor(e,t,i){super(t),this.code=e,this.customData=i,this.name=ii,Object.setPrototypeOf(this,ee.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Te.prototype.create)}}class Te{constructor(e,t,i){this.service=e,this.serviceName=t,this.errors=i}create(e,...t){const i=t[0]||{},r=`${this.service}/${e}`,s=this.errors[e],c=s?ri(s,i):"Error",l=`${this.serviceName}: ${c} (${r}).`;return new ee(r,l,i)}}function ri(n,e){return n.replace(si,(t,i)=>{const r=e[i];return r!=null?String(r):`<${i}?>`})}const si=/\{\$([^}]+)}/g;function oi(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function Le(n,e){if(n===e)return!0;const t=Object.keys(n),i=Object.keys(e);for(const r of t){if(!i.includes(r))return!1;const s=n[r],c=e[r];if(Et(s)&&Et(c)){if(!Le(s,c))return!1}else if(s!==c)return!1}for(const r of i)if(!t.includes(r))return!1;return!0}function Et(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ni{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(ki(t)){const i=t.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(t=>t).join(" ")}}function ki(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ot="@firebase/app",St="0.9.7";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ae=new Yt("@firebase/app"),Mi="@firebase/app-compat",Pi="@firebase/analytics-compat",Di="@firebase/analytics",Oi="@firebase/app-check-compat",Li="@firebase/app-check",Ui="@firebase/auth",xi="@firebase/auth-compat",Bi="@firebase/database",Fi="@firebase/database-compat",Vi="@firebase/functions",$i="@firebase/functions-compat",qi="@firebase/installations",Hi="@firebase/installations-compat",Wi="@firebase/messaging",ji="@firebase/messaging-compat",zi="@firebase/performance",Gi="@firebase/performance-compat",Ki="@firebase/remote-config",Ji="@firebase/remote-config-compat",Qi="@firebase/storage",Yi="@firebase/storage-compat",Xi="@firebase/firestore",Zi="@firebase/firestore-compat",er="firebase",tr="9.19.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ue=new Map,ct=new Map;function ir(n,e){try{n.container.addComponent(e)}catch(t){ae.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function Ie(n){const e=n.name;if(ct.has(e))return ae.debug(`There were multiple attempts to register component ${e}.`),!1;ct.set(e,n);for(const t of Ue.values())ir(t,n);return!0}function en(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ar="firebase-heartbeat-database",cr=1,ye="firebase-heartbeat-store";let et=null;function nn(){return et||(et=Ai(ar,cr,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(ye)}}}).catch(n=>{throw Z.create("idb-open",{originalErrorMessage:n.message})})),et}async function lr(n){try{return(await nn()).transaction(ye).objectStore(ye).get(rn(n))}catch(e){if(e instanceof ee)ae.warn(e.message);else{const t=Z.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});ae.warn(t.message)}}}async function At(n,e){try{const i=(await nn()).transaction(ye,"readwrite");return await i.objectStore(ye).put(e,rn(n)),i.done}catch(t){if(t instanceof ee)ae.warn(t.message);else{const i=Z.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});ae.warn(i.message)}}}function rn(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pr(n){Ie(new ge("platform-logger",e=>new Ni(e),"PRIVATE")),Ie(new ge("heartbeat",e=>new hr(e),"PRIVATE")),de(ot,St,n),de(ot,St,"esm2017"),de("fire-js","")}pr("");var _r="firebase",mr="9.19.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Se{constructor(e,t){this.shortDelay=e,this.longDelay=t,W(t>e,"Short delay should be less than long delay!"),this.isMobile=Yn()||Zn()}get(){return Tr()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ve(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Pr(n,e=!1){const t=le(n),i=await t.getIdToken(e),r=_t(i);T(r&&r.exp&&r.auth_time&&r.iat,t.auth,"internal-error");const s=typeof r.firebase=="object"?r.firebase:void 0,c=s==null?void 0:s.sign_in_provider;return{claims:r,token:i,authTime:ve(tt(r.auth_time)),issuedAtTime:ve(tt(r.iat)),expirationTime:ve(tt(r.exp)),signInProvider:c||null,signInSecondFactor:(s==null?void 0:s.sign_in_second_factor)||null}}function tt(n){return Number(n)*1e3}function _t(n){const[e,t,i]=n.split(".");if(e===void 0||t===void 0||i===void 0)return Me("JWT malformed, contained fewer than 3 sections"),null;try{const r=Jt(t);return r?JSON.parse(r):(Me("Failed to decode base64 JWT payload"),null)}catch(r){return Me("Caught error parsing JWT payload as JSON",r==null?void 0:r.toString()),null}}function Dr(n){const e=_t(n);return T(e,"internal-error"),T(typeof e.exp<"u","internal-error"),T(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Fr(n,e){const t=await ln(n,{},async()=>{const i=be({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:r,apiKey:s}=n.config,c=un(n,r,"/v1/token",`key=${s}`),l=await n._getAdditionalHeaders();return l["Content-Type"]="application/x-www-form-urlencoded",cn.fetch()(c,{method:"POST",headers:l,body:i})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pe(n,e,t){return`firebase:${n}:${e}:${t}`}class he{constructor(e,t,i){this.persistence=e,this.auth=t,this.userKey=i;const{config:r,name:s}=this.auth;this.fullUserKey=Pe(this.userKey,r.apiKey,s),this.fullPersistenceKey=Pe("persistence",r.apiKey,s),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?oe._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,i="authUser"){if(!t.length)return new he(H(Pt),e,i);const r=(await Promise.all(t.map(async I=>{if(await I._isAvailable())return I}))).filter(I=>I);let s=r[0]||H(Pt);const c=Pe(i,e.config.apiKey,e.name);let l=null;for(const I of t)try{const h=await I._get(c);if(h){const k=oe._fromJSON(e,h);I!==s&&(l=k),s=I;break}}catch{}const g=r.filter(I=>I._shouldAllowMigration);return!s._shouldAllowMigration||!g.length?new he(s,e,i):(s=g[0],l&&await s._set(c,l.toJSON()),await Promise.all(t.map(async I=>{if(I!==s)try{await I._remove(c)}catch{}})),new he(s,e,i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hr{constructor(e){this.auth=e,this.queue=[]}pushCallback(e,t){const i=s=>new Promise((c,l)=>{try{const g=e(s);c(g)}catch(g){l(g)}});i.onAbort=t,this.queue.push(i);const r=this.queue.length-1;return()=>{this.queue[r]=()=>Promise.resolve()}}async runMiddleware(e){if(this.auth.currentUser===e)return;const t=[];try{for(const i of this.queue)await i(e),i.onAbort&&t.push(i.onAbort)}catch(i){t.reverse();for(const r of t)try{r()}catch{}throw this.auth._errorFactory.create("login-blocked",{originalMessage:i==null?void 0:i.message})}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ae extends vt{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Yr(n,e,t=!1){const i="signIn",r=await Tn(n,i,e),s=await pe._fromIdTokenResponse(n,i,r);return t||await n._updateCurrentUser(s.user),s}function Xr(n,e,t,i){return le(n).onIdTokenChanged(e,t,i)}function Zr(n,e,t){return le(n).beforeAuthStateChanged(e,t)}function es(n,e,t,i){return le(n).onAuthStateChanged(e,t,i)}const Fe="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ze{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const t=this.receivers.find(r=>r.isListeningto(e));if(t)return t;const i=new ze(e);return this.receivers.push(i),i}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const t=e,{eventId:i,eventType:r,data:s}=t.data,c=this.handlersMap[r];if(!(c!=null&&c.size))return;t.ports[0].postMessage({status:"ack",eventId:i,eventType:r});const l=Array.from(c).map(async I=>I(t.origin,s)),g=await ss(l);t.ports[0].postMessage({status:"done",eventId:i,eventType:r,response:g})}_subscribe(e,t){Object.keys(this.handlersMap).length===0&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(t)}_unsubscribe(e,t){this.handlersMap[e]&&t&&this.handlersMap[e].delete(t),(!t||this.handlersMap[e].size===0)&&delete this.handlersMap[e],Object.keys(this.handlersMap).length===0&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}ze.receivers=[];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,Je=(n,e,t,i,r,s)=>{n.innerHTML=`
  ...
  `),n.querySelector("#stop_charging").addEventListener("click",c)},$o=(n,e,t,i,r,s)=>{var l,g,I,h;const c=k=>{console.log("User connected to charger"),r.publish(`charger/${e}/commands`,`stop:${t.uid}`)};Un(n,e,t,i,r,`
    <div>
  ...
  `),n.querySelector("#stop_charging").addEventListener("click",c)},qo=(n,e,t,i)=>{n.innerHTML=`
    Стан станції заряджання невідомий. Зверніться до технічної підтримки.
  `},Ho=(n,e,t,i,r)=>{const s=t.uid;console.log("---- uid=",s),console.log("charger=",Co);let c=setTimeout(()=>{xo(n,e,t,i,r)},15e3);r.onMessageArrived=l=>{switch(console.log("onMessageArrived",l),clearTimeout(c),l.status){case"init":Bo(n,e,t,i,r);break;case"ready":Fo(n,e,t,i,r);break;case"busy":Vo(n,e,t,i,r,l);break;case"charging":$o(n,e,t,i,r,l);break;default:qo(n)}},Uo(n,e,t,i,r)},Wo=n=>{n.innerHTML=`
  <div class="charger">
    <img src="${Ke}" class="logo" alt="Vite logo" />
...
`},jo=document.getElementById("app"),zo=n=>{if(console.log("App:element",n),!ie)return To(n);const e=new yo,t=new wo("charger_"+ie);t.onMQTTConnect=()=>{console.log("onMQTTConnect"),t.subscribe("charger/"+ie+"/status"),t.subscribe("charger/"+ie+"/data");const i=e.getCurrentUser();i&&t.publish("charger/"+ie+"/commands",`hello:${i.uid}`)},t.onMQTTLost=()=>(console.log("onMQTTLost. TODO: reconnect"),Wo(n)),e.onAuthStateChanged(i=>(console.log("user=",i),i?(t.id="charger_"+ie+"_"+i.uid,t.connect(),Ho(n,ie,i,e,t)):(t.disconnect(),So(n,e))))};zo(jo);
